...
def read_XML_random_not(xmlfile,p=0):
    tree = ET.parse(xmlfile)
    raw_report = tree.find("./MedlineCitation/Article/Abstract")
    report_dict = {}
    for child in raw_report:
...
if __name__ == '__main__':
    dcm_name = "E:\pyProject\Text2image\data\\files\p11\p11000011\\files_p11_p11000011_s51029426_ff213473-b64efa18-863f2bad-76181481-30bc30d7.dcm"
    data = read_dcm(dcm_name)
